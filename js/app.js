...
function initMap() {
  ...
  var contentString = '<h1 class="title is-6 pink-text">Your Current Location</h1>';
...
function gotData(data) {
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    var contentString = '<h2 class="title is-6 pink-text">' + eventName + '</h2>' + '<hr color="black">' +
      '<h3 class="subtitle is-6">' + description + '</h3>' + '<h4 class="center-align subtitle is-6">'
